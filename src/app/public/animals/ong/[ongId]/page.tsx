...
export default function PublicAnimalsByOng({
  params,
}: {
  params: { ongId: string };
}) {
  ...
  useEffect(() => {
    get(`/api/v1/animals/getNotAdoptedByOng/${params.ongId}`)
      .then((response) => {
        setAnimals(response);
      })
      .catch((error) => {
  ...
  return (
    <div className="flex flex-col items-center h-screen">
      {/* TODO: Deixar esse header personalizado de acordo com a ONG em questao */}
      <div className="header-container fixed w-screen h-20 bg-[#EC542B] flex items-center justify-between z-30">
        <div className="flex-grow flex justify-center items-center">
          <div className="relative w-12 h-12 m-3">
            <Image
